import { ArrowRightIcon, ChatIcon, StarIcon } from '@chakra-ui/icons';
import {
    Avatar,
    Box,
    Button,
...
const Forum = () => {
	...
	const onSubmit = (data) => {
		console.log(data);
		axios.post('http://localhost:5000/communityPosts', data).then((res) => {
			...
			<Box bg='white' w='100%' p={4} color='white'>
								...
								<ModalBody>
									<form onSubmit={handleSubmit(onSubmit)}>
										...
										<Textarea
											...
											variant='unstyled'
											placeholder='What on your mind Mr/Mrs'
										/>
										<div
											className='top-btn'
											style={{
				...
				<div
							...
							<>
								...
								<MenuList color='black'>
									...
									<MenuItem
										onClick={() =>
											alert(
												'This Feature is implementing soon'
											)
										}>
										View Profile
									</MenuItem>
					...
					<Text color='black' fontSize='sm'>
						(sm) In love with React & Next (sm) In love with React &
						Next
						<small
